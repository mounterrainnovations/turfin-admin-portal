...
const USER_EMAIL_TEMPLATES: Template[] = [
  {
    id: 1,
    category: "Account",
    name: "Welcome to Turfin",
    subject: "Welcome to Turfin, {userName}!",
  ...
  },
  {
    ...
    subject: "Your Turfin account has been suspended",
  ...
  },
  {
    ...
    subject: "Your Turfin account has been restored",
  ...
  },
  {
    ...
    subject: "Your Turfin account has been scheduled for deletion",
  ...
  },
  {
    ...
    subject: "Action Required: Verify your email on Turfin",
  ...
  },
  {
    ...
    subject: "Action Required: Verify your phone number on Turfin",
  ...
  },
  {
    id: 7,
    category: "Verification",
    name: "Account Not Fully Verified",
    subject: "Complete your Turfin profile verification",
  ...
  },
  {
    ...
    subject: "Reminder: Your Turfin session is coming up soon!",
  ...
  },
  {
    ...
    subject: "Important: High cancellation rate on your account",
  ...
  },
  {
    ...
    subject: "Warning: No-show recorded for a recent booking",
  ...
  },
  {
    ...
    subject: "Your refund has been credited!",
  ...
  },
  {
    ...
    subject: "Exclusive deal unlocked for you, {userName}!",
  ...
  },
  {
    ...
    subject: "Your referral reward is waiting!",
  ...
  },
  {
    ...
    category: "General",
    name: "Review Request",
    subject: "How was your recent Turfin experience?",
  ...
  },
  {
    ...
    subject: "Important updates to the Turfin platform",
...
function EmailModal({ user, onClose }: { user: User; onClose: () => void }) {
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40">
        <div className="bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center gap-4 w-80">
          <div
            ...
            style={{ backgroundColor: "#8a9e60" + "20" }}
          >
            <PaperPlaneTilt
              size={28}
              style={{ color: "#8a9e60" }}
          ...
          <button
            onClick={onClose}
            className="mt-2 px-6 py-2 rounded-lg text-white text-sm font-semibold"
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-2xl w-[780px] max-h-[85vh] flex flex-col overflow-hidden"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-bold text-sm">
                {preview ? "Preview & Send" : "Select Email Template"}
              </p>
              <p className="text-white/60 text-xs">
                To: {user.displayName || `${user.firstName} ${user.lastName}`} ·{" "}
                {user.email}
              </p>
            </div>
          </div>
              ...
              {["All", ...categories].map((cat) => (
                ...
                >
                  ...
                  <span className="ml-1 text-[10px] text-gray-400">
                    (
                    {cat === "All"
                      ? USER_EMAIL_TEMPLATES.length
                      : USER_EMAIL_TEMPLATES.filter((t) => t.category === cat)
                          .length}
                    )
                  </span>
                </button>
                ...
                {displayed.map((t) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <span
                        className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide ${USER_CATEGORY_COLORS[t.category]}`}
                      >
                        {t.category}
                      </span>
                      <Eye size={13} className="text-gray-300 mt-0.5" />
                    </div>
                    <p className="text-xs font-semibold text-gray-800 mb-1 leading-snug">
                      {t.name}
                    </p>
            ...
            <div className="flex flex-1 overflow-hidden">
              <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
                ...
                <div className="bg-[#8a9e60]/5 border border-[#8a9e60]/20 rounded-xl p-3 flex items-center gap-3">
                  ...
                  <span
                    className={`ml-auto text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide ${USER_CATEGORY_COLORS[selected.category]}`}
                  >
                    {selected.category}
                  </span>
                </div>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between shrink-0">
          <p className="text-xs text-gray-400">
            {preview && selected
              ...
              : `${USER_EMAIL_TEMPLATES.length} templates available`}
          </p>
...
export default function UsersPage() {
  ...
  async function handleBan() {
    ...
    try {
      if (isBanned) {
        ...
        showToast({
          title: `${banModal.displayName || banModal.firstName} has been unbanned.`,
          tone: "success",
        });
      } else {
        await banUser(banModal.id, banReason);
        showToast({
          title: `${banModal.displayName || banModal.firstName} has been banned.`,
          tone: "error",
        });
      }
  ...
  return (
    <div className="px-6 py-5">
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-1">
                        <span
                          className={`text-[9px] font-semibold px-1.5 py-0.5 rounded bg-gray-100 text-gray-400`}
                        >
                          Email
                        </span>
                        <span
                    ...
                    >
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          disabled
                          className="p-1.5 rounded text-gray-300 cursor-not-allowed line-through"
                          title="Send Message"
                        >
                        ...
                        <div className="relative">
                          ...
                          {actionMenu === u.id && (
                            <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-20 py-1 min-w-[148px]">
                              ...
                              <button
                                disabled
                                className="w-full text-left px-3 py-2 text-xs text-gray-300 cursor-not-allowed line-through flex items-center gap-2"
                              >
                                <ArrowCounterClockwise
                                  size={13}
        ...
        <div className="fixed inset-0 z-40 flex">
          ...
          <div className="w-[500px] bg-white h-full flex flex-col shadow-2xl overflow-hidden">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {isVip(selectedUser) && (
                        <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-yellow-50 text-yellow-600">
                          VIP
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      <span
                        className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${statusCfg[selectedUser.status]?.cls || statusCfg.active.cls}`}
                      >
                        {statusCfg[selectedUser.status]?.label || "Active"}
                      </span>
                ...
                <>
                    ...
                    <div className="space-y-2.5">
                      {[
                        ...
                        },
                        {
                          icon: Phone,
                          label: "Phone",
                          val: selectedUser.addresses?.[0]?.contactPhone || "—",
                        },
                        {
                          icon: MapPin,
                          label: "Location",
                          val: selectedUser.city
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <div key={label} className="bg-gray-50 rounded-lg p-3">
                          ...
                          <p
                            className={`text-sm font-bold ${highlight ? (label === "Cancellation Rate" ? "text-orange-500" : "text-[#8a9e60]") : "text-gray-800"}`}
                          >
                            {val}
                          </p>
                        </div>
                  ...
                  <section>
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-center gap-3">
                        <div className="w-7 h-7 rounded bg-gray-50 flex items-center justify-center shrink-0">
                          <SoccerBall size={14} className="text-gray-400" />
                        </div>
                        <div>
                          <p className="text-[10px] text-gray-400">
                            Favourite Sports
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {selectedUser.preferredSports?.map((s) => (
                              <span
                                key={s}
                                className="text-[10px] font-semibold px-2 py-0.5 rounded bg-blue-50 text-blue-600 capitalize"
                              >
                                {s}
                              </span>
                            ))}
                            {(!selectedUser.preferredSports ||
                              selectedUser.preferredSports.length === 0) && (
            ...
            <div className="p-4 border-t border-gray-100 flex gap-2 shrink-0">
              ...
              {selectedUser.status === "banned" ? (
                <button
                  onClick={() => setBanModal(selectedUser)}
      ...
      ═══════════════════════════════════════════════════════════════════════ */}
      {msgModal && (
        <EmailModal user={msgModal} onClose={() => setMsgModal(null)} />
      )}
