                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-center">
                        <span
                          className={`inline-flex items-center justify-center w-6 h-6 rounded-lg text-[10px] font-bold transition-colors bg-gray-100 text-gray-700`}
                          title={`${v.turfCount || 0} Total Turfs`}
                        >
                          {v.arenaCount || 0}
                        </span>
                      </td>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-gray-50 rounded-xl p-3 text-center">
                  <p className="text-lg font-bold text-gray-800">
                    {selectedVendor.arenaCount || 0}
                  </p>
                  <p className="text-[10px] text-gray-400">arenas</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-3 text-center">
                  <p className="text-lg font-bold text-gray-800">
