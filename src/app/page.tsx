  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-8">
        <div
          className="bg-white rounded-lg shadow-xl w-full max-w-sm overflow-hidden relative"
          style={{ minHeight: 520 }}
        >
          {/* ── LOGIN PANEL ── */}
          <div
          ...
          >
            ...
            <form onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full py-2.5 text-sm font-semibold text-white uppercase tracking-widest rounded transition-opacity hover:opacity-90 mb-3 flex items-center justify-center"
          ...
          >
            ...
            <a
              href="mailto:admin@turfinapp.in"
              className="text-base font-semibold text-[#8a9e60] hover:underline"
            >
              admin@turfinapp.in
            </a>
            <button
